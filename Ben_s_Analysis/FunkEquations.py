...
# a = 0.076314 b = -0.691085 c = -0.020881 d = 0.015478 e = -10.705555 f = 3.272319 g = 0.000300 h = 3.271603 i = -2.196745 j = 3.055502
def Funk_Equation_LowPPM(X):
    R, H, T = X
    stuff = 0.076314 ** ((((-1 * R) / (H ** -0.691085)) * -0.02088) + (-1 * H * 0.015478) + (-1 * T * -10.705555)
                         + (((-1 * T*3.272319) / (H ** 0.000300)) * 3.271603) -2.196745) + 3.055502
    return stuff
